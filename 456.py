...
for i in range(len(x)):
    ...
    if map_characters[argmax] == anchor_name[0] :
        y_pred.append(anchor_name.index(map_characters[argmax]))

    elif map_characters[argmax] == anchor_name[1] :
        y_pred.append(anchor_name.index(map_characters[argmax]))

    elif map_characters[argmax] == anchor_name[2] :
        y_pred.append(anchor_name.index(map_characters[argmax]))

    elif map_characters[argmax] == anchor_name[3] :
        y_pred.append(anchor_name.index(map_characters[argmax]))

    elif map_characters[argmax] == anchor_name[4] :
        y_pred.append(anchor_name.index(map_characters[argmax]))
